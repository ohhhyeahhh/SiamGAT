...
parser.add_argument('--tracker_path', '-p', type=str, default= '/home/amax/PycharmProjects/results_of_ohhhyeahhh',#'./results',
                    help='tracker result path')
parser.add_argument('--dataset', '-d', type=str, default='UAV123',
                    help='dataset name')
parser.add_argument('--num', '-n', default=1, type=int,
                    help='number of thread to eval')
parser.add_argument('--tracker_prefix', '-t', default='model_10_24_0.3_0.1',
