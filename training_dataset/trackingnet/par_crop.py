...
dataset_path = '/data1/trackingNet/crop511'
# dataset_path = './data'
# sub_sets = ['TRAIN_0', 'TRAIN_1', 'TRAIN_2', 'TRAIN_3', 'TRAIN_4', 'TRAIN_5',
...
def crop_video(video, d_set, crop_path, instanc_size):
    if video != 'list.txt':
        ...
        images_path = join(dataset_path, d_set, 'zip', video)
        f = open(gt_path, 'r')
...
def main(instanc_size=511, num_threads=24):
    ...
    for d_set in sub_sets:
        ...
        videos = listdir(join(dataset_path, d_set, 'zip'))
